...
export default function Home() {
  ...
  return (
    <main>
      <section className="relative bg-gradient-to-b from-rose-950 via-rose-900 to-bg">
        ...
        <div className="relative">
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden space-x-6 text-sm text-rose-200 md:block">
                <Link href="#features">Features</Link>
                <Link href="#pricing">Pricing</Link>
                <Link href="#about">About</Link>
              </nav>
              <Button className="bg-white text-primary hover:bg-rose-50/30 hover:text-white">
            ...
            <div className="mx-auto mt-16 max-w-3xl text-center">
              <h1 className="text-4xl font-bold leading-tight tracking-tighter text-white sm:text-5xl md:text-6xl lg:text-7xl">
                Transform Your Instagram Engagement with Autogram
              </h1>

              <p className="mt-6 text-lg text-rose-200">
                Autogram revolutionizes how you connect with your audience on
              ...
              <div className="mt-8 flex justify-center gap-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="border-red-400  hover:bg-rose-900/50"
                >
                  Learn More
                </Button>
              </div>
